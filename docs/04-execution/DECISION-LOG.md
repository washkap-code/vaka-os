...
| DEC-009 | 2026-07-13 | Accepted | Set current list prices for new workspaces at USD 19 Starter, USD 69 Growth, USD 249 Business, and Enterprise from USD 599/month; use a 30-day standard trial while preserving existing trial end dates. Annual discounts, implementation fees, metered provider usage, and contracted services remain separately governed. | Leadership approved the commercial correction after the live signup path continued to display obsolete prices and a three-month trial. The prior USD 75/150 upper tiers materially underpriced advanced controls, integrations, support, security, and provider costs. | Publish one consistent catalogue across signup, public copy, seed data, and production plans; distinguish live from planned capability; continue willingness-to-pay and margin review without silently changing existing subscriptions. |
