...
- Full DB-backed server suite against guarded local `vaka_os_test`: 73 files / 248 tests passed.
...
- Invoice PDF, finance report PDF and session-renewal suites: 9 tests passed.
...
- Production web build: 46 modules; 475.14 kB main JS / 126.68 kB gzip,
