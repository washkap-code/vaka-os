...
| RISK-010 | Some reports use JavaScript numbers | Reporting | Medium | Trial balance, profit/loss, balance sheet and dashboard financial aggregates now use exact minor-unit arithmetic and return decimal strings. | Preserve exact-money tests when expanding report coverage. | Remediated |
