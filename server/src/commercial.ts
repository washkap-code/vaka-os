...
export const CURRENT_PLANS = [
  ...
  { name: "Business", userLimit: 15, priceAmount: "249.00", features: { inventoryLocations: 5, approvals: true, holdingPageAdvertising: true } },
  { name: "Enterprise", userLimit: 999, priceAmount: "599.00", features: { whiteLabel: true, sla: true, customModules: true, holdingPageAdvertising: true } },
] as const;
